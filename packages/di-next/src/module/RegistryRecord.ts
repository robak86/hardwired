...
export type RegistryRecord = Record<string, Thunk<DependencyResolver<any, any>>>
...
export type MaterializedModuleRegistryContext<TRegistryRecord extends RegistryRecord> = {
  [K in keyof ModuleRegistryContextKeys<TRegistryRecord>]: ModuleRegistryContextKeys<TRegistryRecord>[K] extends RequiresDefinition<
    infer TContext
  >
    ? TContext
    : never;
