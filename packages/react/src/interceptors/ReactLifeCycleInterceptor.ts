import type { ContainerConfigureFn, Definition, IDefinitionToken, LifeTime, ScopeTag } from 'hardwired';
...
export class ReactLifeCycleRootInterceptor extends GraphBuilderInterceptor<never, ReactLifeCycleNode<unknown>> {
  ...
  getGraphNode<TInstance>(
    definition: IDefinitionToken<TInstance, LifeTime.scoped | LifeTime.singleton>,
