                           ...
                           describe(`defineClass`, () => {
                             ...
                             describe(`types`, () => {
                               ...
                               it(`creates module with correct generic types for class with 1 constructor arg`, async () => {
                                 ...
                                 expectType<TypeEqual<typeof m1, Module<{}, { class1: Class1; d1: number }, {}, {}>>>(
                                   true,
                                 );
                               });
                               ...
                               it(`creates module with correct generic types for class with 2 constructor arg`, async () => {
                                 ...
                                 expectType<
                                   TypeEqual<typeof m1, Module<{}, { class2: Class2; d1: number; d2: string }, {}, {}>>
                                 >(true);
                               });
                             });
                           ...
                           describe(`.defineFunction`, () => {
                             describe(`types`, () => {
                               it(`creates correct module type for function without any dependencies`, async () => {
                                 ...
                                 expectType<TypeEqual<typeof m, Module<{}, { noDepsFunction: () => number }, {}, {}>>>(
                                   true,
                                 );
                               });
                               ...
                               it(`creates correct module type for function with single parameter`, async () => {
                                 ...
                                 expectType<
                                   TypeEqual<
                                     typeof m,
                                     Module<{}, { noDepsFunction: (param: string) => number }, {}, {}>
                                   >
                                 >(true);
                               });
                               ...
                               it(`creates correct module type for function with single parameter with all deps provided`, async () => {
                                 ...
                                 expectType<
                                   TypeEqual<
                                     typeof m,
                                     Module<{}, { someString: string; noDepsFunction: () => number }, {}, {}>
                                   >
                                 >(true);
                               });
                               ...
                               it(`creates correct module type for function with two parameters with all deps provided`, async () => {
                                 ...
                                 const m = module('m1')
                                   .define('someString', () => 'someString')
                                   .define('someNumber', () => 123)
                                   .defineFunction('noDepsFunction', someFunction, ctx => [
                                     ctx.someString,
                                     ctx.someNumber,
                                   ]);
                                 ...
                                 expectType<
                                   TypeEqual<
                                     ...
                                     Module<
                                       {},
                                       { someString: string; someNumber: number; noDepsFunction: () => number },
                                       {},
                                       {}
                                     >
                                   >
                             ...
                             describe(`instantiation`, () => {
                               it(`returns correctly curried functions`, async () => {
                                 const someFunction = (someParam: string, someOtherParam: number) => [
                                   someParam,
                                   someOtherParam,
                                 ];
                                 const m = module('m1')
                             ...
                             describe(`types`, () => {
                               it(`creates correct types`, async () => {
                                 ...
                                 expectType<
                                   TypeEqual<
                                     typeof m,
                                     Module<{}, { number: number; string: string }, {}, { externalDependency: number }>
                                   >
                                 >(true);
                               });
                           ...
                           describe(`.toContainer`, () => {
                             describe(`types`, () => {
                               it(`produces container with correct types`, async () => {
                                 ...
                                 expectType<TypeEqual<typeof c1, Container<{}, { a: number; b: string }, {}, {}>>>(
                                   true,
                                 );
                               });
                             });
